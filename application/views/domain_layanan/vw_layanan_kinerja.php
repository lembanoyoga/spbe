...
<section class="section-services section-t8">
  <div class="container">
    ...
    <div class="row">
            <div class="col-md-10">
              <h2>Layanan Administrasi Pemerintahan Berbasis Elektronik - Layanan Kinerja Pegawai</h2>
            </div>
            <div class="col-md-10">
           <b> INDIKATOR 41 <p> 
           Tingkat Kematangan Layanan Kinerja Pegawai.</b> 
          </div>
          <br>
...
<button class="accordion">&nbsp Kriteria Level </button>
<div class="panel">
Kriteria tingkat 2 telah terpenuhi dan Layanan Kinerja Pegawai Berbasis Elektronik memberikan layanan transaksi kepada pengguna terkait kinerja pegawai seperti transaksi basis data, validasi data, mekanisme persetujuan, dan analitik data.
</div>
<button class="accordion">&nbsp Kriteria Pemenuhan Level </button>
<div class="panel">
...
<button class="accordion">&nbsp Kriteria Pemenuhan Level </button>
<div class="panel">
Instansi Pusat/Pemerintah Daerah sudah memiliki layanan kinerja pegawai berbasis elektronik yang dapat berkolaborasi dengan layanan SPBE lainnya, seperti layanan perencanaan, penganggaran, dan/atau dengan layanan kinerja pegawai Instansi Pusat/Pemerintah Daerah lainya.
</div>
<button class="accordion">&nbsp Kriteria Bukti Dukung </button>
<div class="panel">
