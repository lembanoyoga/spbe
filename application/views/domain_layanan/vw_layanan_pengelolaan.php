...
<section class="section-services section-t8">
  <div class="container">
    ...
    <div class="row">
            <div class="col-md-10">
              <h2>Layanan Administrasi Pemerintahan Berbasis Elektronik - Layanan Pengelolaan Barang Milik Negara/Daerah</h2>
            </div>
            <div class="col-md-10">
           <b> INDIKATOR 38 <p> 
           Tingkat Kematangan Layanan Pengelolaan Barang Milik Negara/Daerah.</b> 
          </div>
          <br>
