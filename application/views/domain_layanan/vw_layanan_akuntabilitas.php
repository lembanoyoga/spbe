...
<section class="section-services section-t8">
  <div class="container">
    ...
    <div class="row">
            <div class="col-md-10">
              <h2>Layanan Administrasi Pemerintahan Berbasis Elektronik - Layanan Akuntabilitas Kinerja Organisasi</h2>
            </div>
            <div class="col-md-10">
           <b> INDIKATOR 40 <p> 
           Tingkat Kematangan Layanan Akuntabilitas Kinerja Organisasi.</b> 
          </div>
          <br>
