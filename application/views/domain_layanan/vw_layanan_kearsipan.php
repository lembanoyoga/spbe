...
<section class="section-services section-t8">
  <div class="container">
    ...
    <div class="row">
            <div class="col-md-10">
              <h2>Layanan Administrasi Pemerintahan Berbasis Elektronik - Layanan Kearsipan Dinamis</h2>
            </div>
            <div class="col-md-10">
           <b> INDIKATOR 37 <p> 
           Tingkat Kematangan Layanan Kearsipan.</b> 
          </div>
          <br>
...
<li>Layanan Kearsipan Berbasis Elektronik yang dimaksud merupakan keluaran yang dihasilkan 1 (satu) atau lebih aplikasi yang memberikan nilai manfaat dalam pengelolaan kearsipan Instansi Pusat dan/atau Pemerintah Daerah.</li>
</ol>
</div>
