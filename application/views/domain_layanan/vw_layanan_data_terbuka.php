...
<section class="section-services section-t8">
  <div class="container">
    ...
    <div class="row">
            <div class="col-md-10">
              <h2>Layanan Publik Berbasis Elektronik - Layanan Data Terbuka</h2>
            </div>
            <div class="col-md-10">
           <b> INDIKATOR 43 <p> 
           Tingkat Kematangan Layanan Data Terbuka.</b> 
          </div>
          <br>
...
<li>Data Terbuka(Open Data) adalah serangkaian proses untuk menghasilkan pengelolaan data terbuka Instansi Pusat/Pemerintah Daerah yang efektif, efisien, dan akuntabel.</li>
<li>Data Terbuka merupakan sekumpulan data yang dikelola oleh Instansi Pusat/Pemerintah Daerah yang dapat di bagi pakai oleh Instansi Pusat/Pemerintah Daerah lain.</li>

<li>Layanan Data Terbuka Berbasis Elektronik yang dimaksud merupakan keluaran yang dihasilkan 1 (satu) atau lebih aplikasi yang memberikan nilai manfaat dalam pengelolaan data terbuka Instansi Pusat/Pemerintah Daerah Instansi Pusat dan/atau Pemerintah Daerah.</li>
</ol>
</div>
...
<button class="accordion">&nbsp Kriteria Pemenuhan Level </button>
<div class="panel">
Instansi Pusat/Pemerintah Daerah sudah memiliki Layanan Data Terbuka Berbasis Elektronik yang dapat berkolaborasi dengan layanan SPBE lainnya, seperti layanan kependudukan, perizinan, dan/atau dengan layanan data terbuka Instansi Pusat/Pemerintah Daerah lainya.
</div>
<button class="accordion">&nbsp Kriteria Bukti Dukung </button>
<div class="panel">
