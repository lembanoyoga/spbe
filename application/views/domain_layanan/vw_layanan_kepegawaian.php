...
<section class="section-services section-t8">
  <div class="container">
    ...
    <div class="row">
            <div class="col-md-10">
              <h2>Layanan Administrasi Pemerintahan Berbasis Elektronik - Layanan Kepegawaian</h2>
            </div>
            <div class="col-md-10">
           <b> INDIKATOR 36 <p> 
           Tingkat Kematangan Layanan Kepegawaian.</b> 
          </div>
          <br>
...
<button class="accordion">&nbsp Kriteria Level </button>
<div class="panel">
Kriteria tingkat 1 telah terpenuhi dan Layanan Kepegawaian Berbasis Elektronik memberikan layanan interaksi terkait kepegawaian seperti pencarian informasi, pengunggahan dan pengunduhan dokumen.
</div>
<button class="accordion">&nbsp Kriteria Pemenuhan Level </button>
<div class="panel">
...
<button class="accordion">&nbsp Kriteria Bukti Dukung </button>
<div class="panel">
Dokumentasi yang menggambarkan adanya fungsi yang disajikan oleh sistem aplikasi untuk berinteraksi dengan pengguna, seperti adanya fitur pencarian, upload (unggah) dan/atau download (unduh) dokumen administrasi kepegawaian.
</div>
</div>  
