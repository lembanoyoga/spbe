...
<section class="section-services section-t8">
  <div class="container">
    ...
    <div class="row">
            <div class="col-md-10">
              <h2>Layanan Publik Berbasis Elektronik - Layanan Jaringan Dokumentasi dan Informasi Hukum (JDIH)</h2>
            </div>
            <div class="col-md-10">
           <b>INDIKATOR 44 <p> 
           Tingkat Kematangan Layanan Jaringan Dokumentasi dan Informasi Hukum (JDIH).</b> 
          </div>
          <br>
