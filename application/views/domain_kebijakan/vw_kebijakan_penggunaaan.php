...
<section class="section-services section-t8">
  <div class="container">
    ...
    <div class="row">
            <div class="col-md-10">
              <h2>Kebijakan Internal - Arsitektur SPBE</h2>
            </div>
            <div class="col-md-10">
           <b> INDIKATOR 7 <p> 
           Tingkat Kematangan Kebijakan Internal Penggunaan Sistem Penghubung Layanan Instansi Pusat/ Pemerintah Daerah.</b> 
          </div>
          <br>
          <button class="accordion">&nbsp Penjelasan Indikator </button>
<div class="panel">
<ol type="a">
...
<li>Syarat sebuah Sistem Penghubung Layanan :



<ol>

<li>Tersedia jalur/bus (sistem koneksi bukan point- to-point);</li>

<li>Tersedia metadata repository; dan</li>

<li>Tersedia service directory. </li>
...
<li>
Kebijakan internal dalam hal ini mengatur penerapan Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah.</li>
</ol>
</div>

<button class="accordion">&nbsp Penjelasan Penilaian </button>
<div class="panel">
...
<button class="accordion">&nbsp Penjelasan Bukti Dukung </button>
<div class="panel">
...
<button class="accordion">&nbsp Level 1 </button>
<div class="panel">
<button class="accordion">&nbsp Kriteria Level </button>
<div class="panel">
...
<button class="accordion">&nbsp Kriteria Pemenuhan Level </button>
<div class="panel">
...
<button class="accordion">&nbsp Kriteria Bukti Dukung </button>
<div class="panel">
...
<button class="accordion">&nbsp Level 2 </button>
<div class="panel">
<button class="accordion">&nbsp Kriteria Level </button>
<div class="panel">
...
<button class="accordion">&nbsp Level 3 </button>
<div class="panel">
<button class="accordion">&nbsp Kriteria Level </button>
<div class="panel">
...
<button class="accordion">&nbsp Level 4</button>
<div class="panel">
<button class="accordion">&nbsp Kriteria Level </button>
<div class="panel">
...
<div class="panel">
  <ol>
    <li>Konteks pengaturan/norma arah kebijakan interkoneksi penggunaan Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah dengan Sistem Penghubung Layanan Pemerintah tertuang dalam dokumen kebijakan Instansi Pusat/Pemerintah Daerah; dan   </li>
    <li>Terdapat notulensi/catatan/laporan hasil evaluasi kebijakan internal Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah, bukti undangan rapat evaluasi kebijakan internal Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah, dan/atau dokumentasi aktivitas-aktivitas evaluasi kebijakan internal Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah.</li>
</ol>
</div>
</div>  

<button class="accordion">&nbsp Level 5</button>
<div class="panel">
<button class="accordion">&nbsp Kriteria Level </button>
<div class="panel">
...
<div class="panel">
<ol>
    <li>Terdapat notulensi/catatan/laporan hasil reviu/evaluasi dan rekomendasi tindak lanjut kebijakan internal Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah, yang dapat dilengkapi dengan bukti undangan rapat pembahasan penyempurnaan kebijakan internal penggunaan Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah, dan/atau dokumentasi aktivitas-aktivitas penyempurnaan kebijakan internal penggunaan Sistem Penghubung Layanan Instansi Pusat/Pemerintah Daerah; </li>
    <li>Dokumen kebijakan Instansi Pusat/Pemerintah Daerah yang berlaku sebelumnya; dan</li>
    <li>Dokumen kebijakan Instansi Pusat/Pemerintah Daerah yang memuat pengaturan/norma penggunaan Sistem Penghubung Layanan yang telah disempurnakan dan telah ditetapkan.</li>
