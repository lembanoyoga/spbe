                            ...
                            <td>
                                <div class="media">
                                    ...
                                    <!-- <a onclick="deleteConfirm('<?php echo site_url('home/informasi/'.$rows->id_berita) ?>')"> </a> -->
                                        ...
                                        <a href=<?php echo base_url('/informasi/'.$rows->id_berita) ?> class="forum-title text-primary font-weight-bold"><?php echo $rows->judul_berita ?></a>
                                        <p class="text-muted small mb-0 mt-2"></p><p><?php echo  $rows->isi_berita ?></p>
                                    </div>
                                </div>
                            </td>
