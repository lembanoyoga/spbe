...
<div class="row">
  <div id="modal-edit<?=$row->id_materi;?>" class="modal fade">
    <div class="modal-dialog">
    <?php echo form_open_multipart('dashboard/update_materi');?>
 ...
 <input type="hidden" value="<?=$row->id_materi;?>" name="id_materi" class="form-control" >
 ...
 <div class="form-group">
   ...
   <div class='col-md-11'>
     ...
     <input  type="date" class="form-control"  value="<?=$row->tanggal_materi;?>" required name="tanggal_materi">
     </div>
 </div>
 <div class="form-group">
              <label class='col-md-3'>Upload File</label>
