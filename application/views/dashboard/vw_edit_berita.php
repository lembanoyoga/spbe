  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="page-section">
       ...
       <?php echo form_open_multipart('dashboard/update_berita');?>
                            <?php
  $no = 1;
   foreach ($berita_id as $row): ?>
                                <div class="row card-group-row">
                                <input name="id_berita"
                                                            type="hidden"
                                                            class="form-control"
                                                            value="<?php echo $row->id_berita ?>"
                                                           />
                                            ...
                                            <div class="list-group-item p-3">
                                                <div class="row align-items-start">
                                                    ...
                                                    <div class="col mb-8pt mb-md-0">
                                                        <input name="tanggal_terbit" type="datetime-local" class="form-control publish_date" placeholder="Tanggal Terbit"  value="<?php echo $row->tanggal_terbit ?>" />
                                                      </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="list-group-item p-3">
                                                <div class="row align-items-start">
                                                    ...
                                                    <div class="col mb-8pt mb-md-0">
                                                        ...
                                                        <!-- <span><?php echo $row->gambar_berita ?></span> -->
